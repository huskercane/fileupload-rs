...
impl EncryptFile for UploadedFile {
    fn encrypt(&self) {
        todo!()
        // create a directory with file name and random file name
        // generate private and public key there asymmetric
        // generate key for symmetric
        // save all to file
        // encrypt file with symmetric
        // encrypt symmetric key with asymmetric
        // zip 2 together into one file
        // return private key and random name
        // need both to get the file decrypter, need name to get encrypted file
    }
...
// from https://www.reddit.com/r/rust/comments/3qvmma/encrypting_file_with_asymmetric_encryption/
